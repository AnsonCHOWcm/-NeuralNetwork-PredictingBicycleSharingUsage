...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        output_error_term = error  * hidden_outputs.reshape(len(hidden_outputs),1)
        
        hidden_error_term = X.reshape(len(X),1).dot((hidden_error.T) * (hidden_outputs) * (1-hidden_outputs)) 
